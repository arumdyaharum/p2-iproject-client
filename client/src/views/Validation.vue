...
<div id="login" class="h-screen w-full flex flex-col justify-center items-center">
  ...
  <p class="mb-5">Masukkan Kode OTP yang tercantum pada email <span class="font-bold">{{ user.email }}</span></p>
  <form @submit.prevent="doValidate" class="lg:w-1/4 md:w-1/3 w-1/2 mb-5">
